...
class Command(Generic[_ReturnT_co]):
    ...
    @overload
    def bake(self, *args: Any, _bg: Literal[True], **kwargs: Any) -> "Command[RunningCommand]": ...
    @overload
    def bake(self, *args: Any, _async: Literal[True], **kwargs: Any) -> "Command[RunningCommand]": ...
    @overload
    def bake(self, *args: Any, _return_cmd: Literal[True], **kwargs: Any) -> "Command[RunningCommand]": ...
    @overload
    def bake(self, *args: Any, _return_cmd: Literal[False], **kwargs: Any) -> "Command[str]": ...
    @overload
...
def _aggregate_keywords(keywords: dict, sep: str, prefix: str): ...
